...
export const KeyHighlightsBlock: React.FC<KeyHighlightsBlockProps> = ({
  ...
  return (
    <section className="py-16 md:py-24 bg-linear-to-br from-primary to-secondary">
      <style>{`
        @keyframes fadeInUp {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {highlights?.map((highlight, index) => {
            ...
            return (
              <div
                key={index}
                className="border border-border rounded-xl p-6 space-y-4 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-black/20 text-center flex flex-col items-center bg-white"
                style={{
